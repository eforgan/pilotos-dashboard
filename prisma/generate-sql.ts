...
sql += `INSERT INTO "User" ("id", "email", "password", "role") VALUES ('admin-1', '${adminEmail}', '${adminHash}', 'ADMIN') ON CONFLICT ("email") DO NOTHING;\n`;
